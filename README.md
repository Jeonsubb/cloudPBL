...
- **RAG 연동**: S3의 KOBC 시황·공급망·리스크 보고서와 DCSA 표준·용어집을 Bedrock Knowledge Base로 검색한다. 문서 근거를 사용한 답변은 해당 문장 바로 뒤에 클릭 가능한 `[1]` 형식의 출처를 표시한다. 회사 실제 계약서·사내DB는 아직 연결하지 않았다.
